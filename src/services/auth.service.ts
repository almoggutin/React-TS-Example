...
import { ISuccessResponse, IErrorResponse } from '../models/response.model';

export const login = async (email: string, password: string): Promise<ISuccessResponse | IErrorResponse> => {
...
export const signup = async (userData: IUser): Promise<ISuccessResponse | IErrorResponse> => {
...
export const logout = async (userID: string): Promise<ISuccessResponse | IErrorResponse> => {
